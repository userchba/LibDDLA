...
void launch_core(
    ...
    const MaxDimensions& maximum,
    int* d_m, int* d_n, int* d_k,
    std::complex<double> alpha, const std::complex<double>* const* d_A_array, int* d_lda,
    const std::complex<double>* const* d_B_array, int* d_ldb,
...
void launch_core_2s(
    ...
    const MaxDimensions& maximum_0,
    int* d_m_0, int* d_n_0, int* d_k_0,
    std::complex<double> alpha_0, const std::complex<double>* const* d_A_array_0, int* d_lda_0,
    const std::complex<double>* const* d_B_array_0, int* d_ldb_0,
    std::complex<double> beta_0, std::complex<double>** d_C_array_0, int* d_ldc_0,
    ddla::deblasOperation_t transA_1, ddla::deblasOperation_t transB_1,
    const MaxDimensions& maximum_1,
    int* d_m_1, int* d_n_1, int* d_k_1,
    std::complex<double> alpha_1, const std::complex<double>* const* d_AB_array_1,
    int* d_lda_1, int* d_ldb_1,
